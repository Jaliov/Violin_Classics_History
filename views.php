...
<div class='card card-body text-light bg-transparent' style='box-shadow:3 5;'><span>";

$view1 = $card . "<iframe id ='player' src='$clip14' allowfullscreen' class='embed-responsive-item border border-light'></iframe></div><div class='card-body'>" . $collapse . $colAdd1 .
...
$view3  = $card . "<iframe id ='player' class='embed-responsive-item border border-light' src='$clip11'allowfullscreen></iframe></div><div class='card-body mb-3'>" . $collapse . $colAdd3 .
...
$view5  = $card . "<iframe id ='player' class='embed-responsive-item border border-light' src='$clip3'allowfullscreen></iframe></div><div class='card-body'>" .  $collapse . $colAdd6 . "Beethoven Violin Concerto in D</card></button><br>";
...
$view10 = $card . "<iframe id ='player' class='embed-responsive-item border border-light' src='$clip13'allowfullscreen></iframe></div><div class='card-body'>" .  $collapse . $colAdd11 . "Sibelius Violin Concerto</button><br>";
