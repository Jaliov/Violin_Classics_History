...
$view11 = $card . "<iframe id ='player' class='embed-responsive-item' src='$clip15'></iframe></div><div class='card-body'>" . $collapse . $colAdd5 . "Mozart Sinfonia Concertante in E Flat Majore</button>";
...
$view5  = $card . "<iframe id ='player' class='embed-responsive-item' src='$clip3'></iframe></div><div class='card-body'>" .  $collapse . $colAdd6 . "Beethoven Violin Concerto in D</card></button>";
